...
python train.py --gpu 2,3 --expId vgg16_attention_recurrent_first_unroll5 --init_lr 1e-4 --network_config vgg16_att_recurrent_first_unroll5.cfg --lr_freq 30 --optim 1 --init_weight vgg --data_path /data2/simingy/data/ 
