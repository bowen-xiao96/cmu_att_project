...
python train.py --gpu 0,1,2,3 --expId vgg16_attention_recurrent_last_c --init_lr 1e-4 --network_config vgg16_att_recurrent_last.cfg --lr_freq 30 --optim 1 --init_weight vgg --att_channel 512  --data_path /data2/simingy/data/ 
